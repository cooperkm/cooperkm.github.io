...
var getBrowserImage = function(selectedBrowser) {
    ...
    switch (selectedBrowser) {
        case BROWSER.CHROME:
            return '<img src="/resources/images/chromeIcon.png" alt="Chrome">';
        case BROWSER.EDGE:
            return '<img src="/resources/images/edgeIcon.png" alt="Edge">';
        case BROWSER.FIREFOX:
            return '<img src="/resources/images/firefoxIcon.png" alt="Fire Fox">';
        case BROWSER.IE:
            return '<img src="/resources/images/ieIcon.png" alt="Internet Explorer">';
        case BROWSER.OPERA:
            return '<img src="/resources/images/operaIcon.png" alt="Opera">';
        case BROWSER.SAFARI:
            return '<img src="/resources/images/safariIcon.png" alt="Safari">';
        case BROWSER.UNKNOWN:
        default:
            cod
            return '<img src="/resources/images/questionMarkIcon.png" alt="Could not detect browser">';;
    }
};
...
var multicodec = function() {
    ...
    var config = {
        key: '278aa40a-9800-4e02-8735-b24be4ea5be4',
        analytics: {
            key: 'be0cf8d4-5a87-422e-8062-54042e8862bb',
